...
public class GenerateNFKC
{
    ...
    throws Exception
  {
    ...
    path += "gnu"+File.separator+"inet"+File.separator+"encoding"+File.separator;
    ...
    {
      PrintWriter w = new PrintWriter(new FileWriter(path + "CombiningClass.java"));
    ...
    {
      PrintWriter w = new PrintWriter(new FileWriter(path + "DecompositionKeys.java"));
      w.println("/* This file is automatically generated.  DO NOT EDIT!");
      w.println("   Instead, edit GenerateNFKC.java and re-run.  */");
      w.println();
      w.println("package gnu.inet.encoding;");
    ...
    {
      PrintWriter w = new PrintWriter(new FileWriter(path + "DecompositionMappings.java"));
      w.println("/* This file is automatically generated.  DO NOT EDIT!");
      w.println("   Instead, edit GenerateNFKC.java and re-run.  */");
      w.println();
      w.println("package gnu.inet.encoding;");
    ...
    {
      PrintWriter w = new PrintWriter(new FileWriter(path + "Composition.java"));
      w.println("/* This file is automatically generated.  DO NOT EDIT!");
      w.println("   Instead, edit GenerateNFKC.java and re-run.  */");
      w.println();
      w.println("package gnu.inet.encoding;");
